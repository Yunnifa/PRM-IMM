              ...
              <tr key={user.id} className="hover:bg-gray-50">
                ...
                <td className="px-2 lg:px-4 py-2 lg:py-3 text-xs lg:text-sm">
                  <span className={`px-2 py-1 rounded-full text-xs font-semibold ${
                    ...
                    user.role === 'head_ga' ? 'bg-blue-100 text-blue-800' :
                    user.role === 'head_os' ? 'bg-indigo-100 text-indigo-800' :
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  value={formData.role}
                  onChange={(e) => setFormData({ ...formData, role: e.target.value as 'admin' | 'head_ga' | 'head_os' | 'user' })}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                >
                  <option value="user">User</option>
                  <option value="admin">Admin</option>
                  <option value="head_ga">Head GA</option>
                  <option value="head_os">Head OS</option>
                </select>
              </div>
            </div>
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  value={formData.role}
                  onChange={(e) => setFormData({ ...formData, role: e.target.value as 'user' | 'admin' | 'head_ga' | 'head_os' })}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                >
                  <option value="user">User</option>
                  <option value="admin">Admin</option>
