...
const DataUser = () => {
  ...
  const [formData, setFormData] = useState({ 
    ...
    birthDate: '',
    department: '', 
    role: 'user' as 'admin' | 'head' | 'ga' | 'user'
  });
  ...
  const handleEdit = (user: User) => {
    ...
    setFormData({ 
      ...
      role: user.role as 'admin' | 'head' | 'ga' | 'user'
    });
              ...
              <tr key={user.id} className="hover:bg-gray-50">
                ...
                <td className="px-2 lg:px-4 py-2 lg:py-3 text-xs lg:text-sm">
                  <span className={`px-2 py-1 rounded-full text-xs font-semibold ${
                    ...
                    {user.role === 'head' ? 'HEAD DEPT' : user.role === 'ga' ? 'GA' : user.role.toUpperCase()}
                  </span>
                </td>
                <td className="px-2 lg:px-4 py-2 lg:py-3 text-xs lg:text-sm">
                  <button
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-md max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  value={formData.role}
                  onChange={(e) => setFormData({ ...formData, role: e.target.value as 'admin' | 'head' | 'ga' | 'user' })}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                >
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-md max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  value={formData.role}
                  onChange={(e) => setFormData({ ...formData, role: e.target.value as 'user' | 'admin' | 'head' | 'ga' })}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                >
                  <option value="user">User</option>
                  <option value="admin">Admin</option>
